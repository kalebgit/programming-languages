...
{-
desugar (Conc e l) = case e of -- esta funcion debe estar en el nucleo puesto que ListV es un caso especifico
    List [] -> desugar l
    other -> ConsV (desugar e) (desugar l) -}
desugar (Conc e l) = ConcV (desugar e) (desugar l)    
-- Núcleo de listas
