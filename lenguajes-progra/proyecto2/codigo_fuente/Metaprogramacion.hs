...
-- ============================================================
-- METAPROGRAMACION INSPECCION DE CODIGO
-- un caso particular que muhcas veces se aplica
-- ============================================================
...
-- detectar si una expresion tiene divisiones
...
-- ============================================================
-- METAPROGRAMACION  OPTIMIZACION DE CODIGO
-- ============================================================

-- El programa puede reescribirse a si mismo
-- en este caso hacemos optimizacion de operaciones aritmeticas
