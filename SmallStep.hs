...
-- ========= ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======= 
-- ========= ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======= 
    -- TODO: Se  concatena para variadicos con ANDS.
-- ========= ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======= 
-- ========= ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======= 
...
smallStep (ConcV expr expr2) env = case (expr,expr2) of
    (NilV, ConsV e1 e2) -> ((ConsV e1 e2), env)
    (ConsV e1 e2, NilV) -> ((ConsV e1 e2), env)
    (NilV,NilV) -> (NilV, env)
    (e1,e2) -> case isValue e1 of
    
      True -> case isValue e2 of
        True -> case e2 of
          ConsV x y -> (ConsV e1 e2, env) -- este es el caso que resulve, lo que se espera es que el segundo argumnto sea una lista, pues de otro modo no va a jalar
          NilV -> (ConsV e1 NilV, env)
          other -> error "el segundo argumento debe de ser una lista"
        False -> case smallStep e2 env of
          (e', env') -> (ConcV e1 e', env')
          
      False -> case smallStep e1 env of
        (e', env') -> (ConcV e' e2, env')
...
-- Esta función se encarga de evaluar el cuerpo, !!! lo malo es que se evalua de golpe, violando la semantica natural de paso pequeño¡¡¡¡
evalBody :: ASAValues -> Env -> ASAValues
evalBody e env
    | isValue e = e
